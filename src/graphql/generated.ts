...
export type Lesson = Node & {
  ...
  complementaryMaterial?: Maybe<Scalars['String']>;
  /** The time the document was created */
  createdAt: Scalars['DateTime'];
  /** User that created this document */
  createdBy?: Maybe<User>;
  ...
  exclusiveWallpapers?: Maybe<Scalars['String']>;
...
export type LessonCreateInput = {
  ...
  complementaryMaterial?: InputMaybe<Scalars['String']>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  description?: InputMaybe<Scalars['String']>;
  exclusiveWallpapers?: InputMaybe<Scalars['String']>;
  lessonType: LessonType;
  slug: Scalars['String'];
...
export type LessonManyWhereInput = {
  ...
  complementaryMaterial?: InputMaybe<Scalars['String']>;
  /** All values containing the given string. */
  complementaryMaterial_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
  complementaryMaterial_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  complementaryMaterial_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values that are not equal to given value. */
  complementaryMaterial_not?: InputMaybe<Scalars['String']>;
  /** All values not containing the given string. */
  complementaryMaterial_not_contains?: InputMaybe<Scalars['String']>;
  /** All values not ending with the given string */
  complementaryMaterial_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  complementaryMaterial_not_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values not starting with the given string. */
  complementaryMaterial_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  complementaryMaterial_starts_with?: InputMaybe<Scalars['String']>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  createdAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
  ...
  exclusiveWallpapers?: InputMaybe<Scalars['String']>;
  /** All values containing the given string. */
  exclusiveWallpapers_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
  exclusiveWallpapers_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  exclusiveWallpapers_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values that are not equal to given value. */
  exclusiveWallpapers_not?: InputMaybe<Scalars['String']>;
  /** All values not containing the given string. */
  exclusiveWallpapers_not_contains?: InputMaybe<Scalars['String']>;
  /** All values not ending with the given string */
  exclusiveWallpapers_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  exclusiveWallpapers_not_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values not starting with the given string. */
  exclusiveWallpapers_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  exclusiveWallpapers_starts_with?: InputMaybe<Scalars['String']>;
  id?: InputMaybe<Scalars['ID']>;
  /** All values containing the given string. */
  id_contains?: InputMaybe<Scalars['ID']>;
  /** All values ending with the given string. */
...
export enum LessonOrderByInput {
  ...
  ComplementaryMaterialAsc = 'complementaryMaterial_ASC',
  ComplementaryMaterialDesc = 'complementaryMaterial_DESC',
  CreatedAtAsc = 'createdAt_ASC',
  CreatedAtDesc = 'createdAt_DESC',
  DescriptionAsc = 'description_ASC',
  DescriptionDesc = 'description_DESC',
  ExclusiveWallpapersAsc = 'exclusiveWallpapers_ASC',
  ExclusiveWallpapersDesc = 'exclusiveWallpapers_DESC',
  IdAsc = 'id_ASC',
  IdDesc = 'id_DESC',
...
export type GetLessonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, description?: string | null, videoId: string, complementaryMaterial?: string | null, exclusiveWallpapers?: string | null, teacher?: { __typename?: 'Teacher', name: string, bio: string, avatarURL: string } | null, challenge?: { __typename?: 'Challenge', url: string } | null } | null };
...
export type GetLessonsSlugsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', slug: string }> };
